...
pub fn search_terms(bundle: &Bundle, query_terms: &[&str], k: usize) -> Vec<(u32, f32)> {
    ...
    if n == 0 || k == 0 || query_terms.is_empty() {
        return Vec::new();
    }
